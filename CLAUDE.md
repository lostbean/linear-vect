...
linear-vect is a Haskell library for low-dimensional linear algebra (2D, 3D, 4D vectors, matrices, quaternions). Fork of the vect library using Num typeclass.
...
BSD-3-Clause (fork with upstream copyright holders).
