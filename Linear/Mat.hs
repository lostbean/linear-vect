...
instance (Num a, Random a) => Random (Mat2 a) where
    random = randomR (Mat2 v1 v1, Mat2 v2 v2)
      where
        v1 = Vec2 (-1) (-1)
        v2 = Vec2 1 1
...
instance (Num a, Random a) => Random (Mat3 a) where
    random = randomR (Mat3 v1 v1 v1, Mat3 v2 v2 v2)
      where
        v1 = Vec3 (-1) (-1) (-1)
        v2 = Vec3 1 1 1
...
instance (Num a) => Tensor (Mat4 a) (Vec4 a) where
    outer (Vec4 a b c d) (Vec4 x y z w) =
        Mat4
...
instance (Num a, Random a) => Random (Mat4 a) where
    random = randomR (Mat4 v1 v1 v1 v1, Mat4 v2 v2 v2 v2)
      where
        v1 = Vec4 (-1) (-1) (-1) (-1)
        v2 = Vec4 1 1 1 1
